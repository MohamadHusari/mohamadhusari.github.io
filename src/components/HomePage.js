...
class HomePage extends Component {
    ...
    componentWillMount() {
        ...
        document.title = 'Mohamad Husari - Home page';
    }
            ...
            <div className="container portfolio position-relative">
                <div className="row no-gutters">
                    <div className="col-md-12">
                        <div className="heading clearfix">
                            ...
                            {pathname === `${path}` && <span className="font-weight-bold" onClick={this.titlechange('Home page')}>Home</span>}
                            {pathname === `${path}/contact-me` && <span className="font-weight-bold" onClick={this.titlechange('Contact page')}>Contact</span>}
                ...
                <div className="bio-info pb-2">
                    <div id="main" className={`row no-gutters sidenav ${this.state.show ? 'showsidenav rounded-bottom' : ''}`}>
                        ...
                        <div className="col-12 col-md-4">
                            {/*<a href="#">Contact</a>*/}
                            <NavLink className="nav-link" to={`${path}/contact-me`} activeClassName="selected">Contact</NavLink>
                        </div>
                    </div>
                    <Switch>
